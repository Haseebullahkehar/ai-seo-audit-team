...
import os
from google_adk import RootAgent
from typing import List, Optional
from pydantic import BaseModel, Field
from google_adk.agents import LlmAgent, SequentialAgent
from google_adk.tools import google_search
from google_adk.tools.agent_tool import AgentTool
from google_adk.tools.mcp_tool.mcp_toolset import MCPToolset, StdioServerParameters
...
root_agent = RootAgent(
    ...
    instructions="You are an expert SEO agent that performs crawls, SERP research, and produces reports."
)
